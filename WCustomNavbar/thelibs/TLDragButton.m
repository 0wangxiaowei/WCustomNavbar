...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        [self addGestureRecognizer:longGesture];
         self.imageEdgeInsets =UIEdgeInsetsMake(5, 15, 40, 15);
        _titleLab =[[UILabel alloc] initWithFrame:CGRectMake(0, kScreenWidth/4-23,kScreenWidth/4, 30)];
